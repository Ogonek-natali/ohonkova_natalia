...
import ua.khpi.oop.Ohonkova15.Container;
import ua.khpi.oop.Ohonkova15.Store;
import ua.khpi.oop.Ohonkova15.Util;
	            ...
	            case 9:
	                if (linkedContainer.notEmpty()) {
	                    ...
	                    while (loop2) {
	                        switch (choose2) {
	                            case 1:
	                                linkedContainer.sortProducts();
	                                loop2 = false;
	                                break;
	                            case 2:
	                            	linkedContainer.sortPrice();
	                                loop2 = false;
	                                break;
	                            case 3:
	                            	linkedContainer.sortDate();
	                                loop2 = false;
	                                break;
	                            default:
